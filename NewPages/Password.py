...
def Display():
        ...
        label3 = tk.Label(text = "Secondary Password: ",bg = "white", width = 20, font = ("arial", 10,"bold"))   
        label3.place(x =10, y=180)
        label4 = tk.Label(text = "New Password: ",bg = "white", width = 15, font = ("arial", 10,"bold"))   
        label4.place(x =10, y=230)
        submit=tk.Button(text="Submit")
        submit.place(x=0,y=280)
        entry_1 = tk.Entry()
        entry_1.place(x = 80, y =130)
        entry_2 = tk.Entry()
        entry_2.place(x = 170, y =180)
        entry_3 = tk.Entry()
        entry_3.place(x=130, y=230)
