...
import GeneratorPage,login,signUp,Service,updateService,Sending,Available,Acceptance,PasswordManager,client,Safety,sentPass
...
def Display():
    ...
    currentlySending=Button(root,text="Outgoing Passwords",command=sentPassPage)
    currentlySending.pack()
    passwordSafety=Button(root,text="Safety check",command=safetyPage)
    passwordSafety.pack()
